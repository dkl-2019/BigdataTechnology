...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        // 设置输出路径
        TextOutputFormat.setOutputPath(job, new Path("hdfs://master:9000/wordcount_out1"));
        // TextOutputFormat.setOutputPath(job, new Path("file:///D:\\mapreduce\\output"));  // 本地形式
        Path path = new Path("hdfs://master:9000/wordcount_out1");
